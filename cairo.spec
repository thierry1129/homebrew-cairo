...
%prep
%setup -q -n cairo-1.14.10
%patch1 -p1
%patch2 -p1
pushd ..
cp -a cairo-1.14.10 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1497626604
...
/usr/lib64/libcairo-gobject.so.2.11400.10
/usr/lib64/libcairo-script-interpreter.so.2
/usr/lib64/libcairo-script-interpreter.so.2.11400.10
/usr/lib64/libcairo.so.2
/usr/lib64/libcairo.so.2.11400.10
...
/usr/lib32/libcairo-gobject.so.2.11400.10
/usr/lib32/libcairo-script-interpreter.so.2
/usr/lib32/libcairo-script-interpreter.so.2.11400.10
/usr/lib32/libcairo.so.2
/usr/lib32/libcairo.so.2.11400.10
